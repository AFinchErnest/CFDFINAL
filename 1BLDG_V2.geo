...
h1 = 0.5; //outer mesh size
h2 = 0.05*h1; //inner mesh size
...
//Distance and Threshold Fields from the Building
Field[1] = Distance;
Field[1].Sampling = 100; //Number of evenly spaced points from which the field samples from
Field[1].SurfacesList = {7, 8, 9, 10, 11};

Field[2] = Threshold;
Field[2].InField = 1; //refrencing the distance field
Field[2].SizeMin = h2;
Field[2].SizeMax = h1;
Field[2].DistMin = .15;
Field[2].DistMax = .5;
